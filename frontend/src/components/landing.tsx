          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input 
                ...
                readOnly 
                type="url" 
                value={`${BACKEND_UPLOAD_URL}/files/${uploadId}/index.html`} 
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="file-path">Local File Path</Label>
              <Input 
                id="file-path" 
                readOnly 
                value={`D:/vercel-app/dist/${uploadId}/index.html`} 
              />
            </div>
            <Button className="w-full" variant="outline">
              <a 
                href={`${BACKEND_UPLOAD_URL}/files/${uploadId}/index.html`} 
                target="_blank" 
